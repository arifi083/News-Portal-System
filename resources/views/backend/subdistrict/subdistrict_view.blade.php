  ...
  <a href="{{ route('add.subdistrict')  }}"><button type="button" class="btn btn-primary btn-fw" style="float: right;">Add SubDistrict</button></a>	              	
      ...
      <tr>
        ...
        <td> 
           ...
           <a href="{{ route('subdistrict.edit',$row->id) }}" class="btn btn-primary">Edit</a>
           <a href="{{ route('subdistrict.delete',$row->id) }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger">Delete</a>
      </tr>
      @endforeach
