                ...
                <form class="forms-sample" method="POST" action="{{ route('update.prayer',$prayer->id) }}">
                     @csrf
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Fazr</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Zuhar</label>
                        <input type="text" class="form-control" name="zuhar" value="{{ $prayer->zuhar }}">
                        @error('zuhar') 
	                        <span class="text-danger">{{ $message }}</span>
	                    @enderror
                      </div>
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Asar</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Isha</label>
                        <input type="isha" class="form-control" name="isha" value="{{ $prayer->isha }}">
                        @error('isha') 
	                        <span class="text-danger">{{ $message }}</span>
	                    @enderror
                      </div>
