                ...
                <form class="forms-sample" method="POST" action="{{ route('district.store') }}">
                     @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="district_en" placeholder="District English"  id="exampleInputEmail1">
                        @error('district_en') 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="district_bn" class="form-control" id="exampleInputEmail1" placeholder="District Bangla">
                        @error('district_bn') 
	                        <span class="text-danger">{{ $message }}</span>
	                    @enderror
                      </div>
