            ...
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <form class="forms-sample" method="POST" action="{{ route('update.district',$district->id) }}">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="district_en" value="{{ $district->district_en }}" placeholder="District English"  id="exampleInputEmail1">
                        @error('district_en') 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="district_bn" value="{{ $district->district_bn }}" class="form-control" id="exampleInputEmail1" placeholder="District Bangla">
                        @error('district_bn') 
	                        <span class="text-danger">{{ $message }}</span>
	                    @enderror
                      </div>
