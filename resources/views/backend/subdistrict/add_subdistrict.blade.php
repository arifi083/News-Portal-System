                ...
                <form class="forms-sample" method="POST" action="{{ route('subdistrict.store') }}">
                     @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subdistrict_en" placeholder="SubDistrict English"  id="exampleInputEmail1">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="subdistrict_bn" class="form-control" id="exampleInputEmail1" placeholder="SubDistrict Bangla">
