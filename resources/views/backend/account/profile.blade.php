...
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="{{ (!empty($editData->profile_photo_path))?url('upload/user_images/'.$editData->profile_photo_path):url('upload/no_image.jpg') }}" alt="Card image cap">
  <div class="card-body">
