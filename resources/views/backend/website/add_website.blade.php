                ...
                <form class="forms-sample" method="POST" action="{{ route('website.store') }}">
                     @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="website_name" placeholder="website name"  id="exampleInputEmail1">
                        @error('website_name') 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="website_link" class="form-control" id="exampleInputEmail1" placeholder="website link">
                        @error('website_link') 
	                        <span class="text-danger">{{ $message }}</span>
	                    @enderror
                      </div>
