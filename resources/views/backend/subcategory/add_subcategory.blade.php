                ...
                <form class="forms-sample" method="POST" action="{{ route('subcategory.store') }}">
                     @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subcategory_en" placeholder="Subcategory English"  id="exampleInputEmail1">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="subcategory_bn" class="form-control" id="exampleInputEmail1" placeholder="Subcategory Bangla">
