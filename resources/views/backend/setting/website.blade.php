        ...
        <form class="forms-sample" method="POST" action="{{ route('update.websetting',$websitesetting->id) }}" enctype="multipart/form-data" >
            ...
            <div class="row">
               ...
               <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" name="phone_en" value="{{ $websitesetting->phone_en }}">
               </div>

              <div class="form-group col-md-4">
                  <label for="exampleInputName1">Phone Bangla</label>
                  <input type="text" class="form-control" id="exampleInputName1" name="phone_bn" value="{{ $websitesetting->phone_bn }}">
               </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="address_en" id="summernote">{{ $websitesetting->address_en }}</textarea>
            </div>

            <div class="form-group">
                <label for="exampleTextarea1">Address Bangla</label>
                <textarea class="form-control" name="address_bn" id="summernote1">{{ $websitesetting->address_bn }}</textarea>
            </div>
